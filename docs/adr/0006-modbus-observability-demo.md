...
- `cloud-itonami-hygiene-access`: `kbb -M:test` green — 183 tests / 663 assertions (up from ADR-0005's 181/631; two new tests, `hygaccess.modbus-integration-test`). `kbb -M:lint` clean (0 errors, 0 warnings).
